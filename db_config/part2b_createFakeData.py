...
GCP_MYSQL_HOSTNAME = os.getenv("MYSQL_HOSTNAME")
GCP_MYSQL_USER = os.getenv("MYSQL_USERNAME")
GCP_MYSQL_PASSWORD = os.getenv("MYSQL_PASSWORD")
GCP_MYSQL_DATABASE = os.getenv("MYSQL_DATABASE")
